        ...
        if obj.fields:
            ...
            for field in obj.fields:
                ...
                if field_comment and field_comment != field_name:
                    ...
                    field_list.append(f"({field_name}:{field.field_type}, 业务名称:{field_comment})")
                elif field_comment:
                    field_list.append(f"({field_name}:{field.field_type}, {field_comment})")
                else:
                    field_list.append(f"({field_name}:{field.field_type})")
            schema_table += ",\n".join(field_list)
        schema_table += '\n]\n'
